<div class="min-h-screen py-10 bg-gray-100 screen" x-data="{ openModel: false }">
    ...
    <div class="w-full sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h1 class="text-xl font-semibold text-gray-900">{{ __('All Blog Categories') }}</h1>
        </div>
                            ...
                            @if (count($categories))
                                @foreach ($this->categories as $category)
                                    <tr class="text-xs text-gray-700">
                                                ...
                                                <div
                                                    ...
                                                    @else
                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                            class="w-8 h-8 text-gray-300" fill="none"
                                        ...
                                        <td class="px-2 py-3 whitespace-nowrap">{{ count($category->blogs) }}
                                        </td>
                                        <td class="px-2 py-3 whitespace-nowrap">
                                            <div class="relative">
                ...
                <div class="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
                    <div
                        ...
                        <div class="flex items-center justify-center w-full h-12 px-2 mx-auto text-white bg-blue-500">
                            ...
                            <h1>{{ !$this->readOnly ? __('Add Category') : __('View Category') }}
                            </h1>
                        </div>
                        <button
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="relative mt-1 rounded-md shadow-sm">
                                        <input type="number" wire:model.defer="sort"
                                            {{ $readOnly ? 'disabled' : '' }}
                                            class="sort block w-full border-gray-300 rounded-md peer read-only:bg-gray-100 placeholder:text-gray-400 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                                            ...
                                            <div x-data="{ isUploading: false, progress: 0 }"
                                                ...
                                                <label
                                                    ...
                                                    <div
                                                        ...
                                                        <span
                                                            class="text-sm text-gray-600 ltr:ml-2 rtl:mr-2">{{ __('Browse image') }}
                                                    </div>
                            ...
                            <div
                                ...
                                <div class="mt-2">
                                    ...
                                    <p class="text-sm text-red-500 uppercase">
                                        {{ __('All blogs of this category will be deleted. Make sure to move posts into another category before delete') }}
                                    </p>
                                </div>
                            </div>
                        </div>
